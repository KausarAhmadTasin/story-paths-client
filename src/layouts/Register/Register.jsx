  ...
  return (
    <div>
      ...
      <div className="flex justify-center py-24 lg:py-0 lg:min-h-screen items-center bg-[url('https://i.ibb.co/4K1nyzb/seamless-circle-G03-GBB.jpg')] bg-repeat bg-auto">
        <div className="lg:w-1/3 w-11/12 md:w-3/4 mt-16 mb-20 border border-gray-300 rounded-md bg-black bg-opacity-80">
          <form onSubmit={handleRegister} className="p-6">
            <div className="mb-4">
              ...
              <input
                type="text"
                placeholder="Name"
                className="w-full px-3 py-2 bg-white text-gray-600 border border-gray-300 rounded focus:outline-none focus:border-blue-500"
                required
                autoFocus
                name="name"
              />
